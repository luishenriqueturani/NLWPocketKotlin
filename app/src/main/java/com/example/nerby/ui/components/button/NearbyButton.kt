package com.example.nerby.ui.components.button
...
private fun NearbyButtonPreview() {
  NearbyButton(modifier = Modifier.fillMaxWidth(), text = "Button", iconRes = R.drawable.ic_scan) {}
}
...
private fun NearbyButtonNoIconPreview() {
  NearbyButton(modifier = Modifier, text = "Button") {}
}